...
public class FruitTest {
    public class TradeShopTest {
        ...
        public void setUp() {
            ...
            firstListOfFruits.add(new Fruit(TypeOfFruit.Cherry, 5, firstDate, 85));
            firstListOfFruits.add(new Fruit(TypeOfFruit.Grape, 7, firstDate, 40));
            StoreUtil.writeToFile(firstListOfFruits, FIRST_FILE);

            secondListOfFruits.add(new Fruit(TypeOfFruit.Apple, 15, secondDate, 25));
            secondListOfFruits.add(new Fruit(TypeOfFruit.Orange, 5, secondDate, 55));
        ...
        public void testGetSpoiledFruitsByType() {
            tradeShop.addFruits(FIRST_FILE);
            LocalDate date = LocalDate.of(2019, 4, 1);
            List<Fruit> spoiledFruits = tradeShop.getSpoiledFruits(date, TypeOfFruit.Lemon);
        ...
        public void testGetAvailableFruitsByType() {
            tradeShop.addFruits(FIRST_FILE);
            LocalDate date = LocalDate.of(2019, 4, 1);
            List<Fruit> availableFruits = tradeShop.getAvailableFruits(date, TypeOfFruit.Melon);
        ...
        public void testGetAddedFruitsByType() {
            ...
            List<Fruit> addedFruits = tradeShop.getAddedFruits(date, TypeOfFruit.Watermelon);
